...
class SebelumSection extends StatefulWidget {
  final String namaTanaman;

  SebelumSection({required this.namaTanaman});

  @override
  _SebelumSectionState createState() => _SebelumSectionState();
}

class _SebelumSectionState extends State<SebelumSection> {
